 ...
 */
export async function sendOtpEmail(to, name, otp, country) {
    ...
    try {
        ...
        if (error instanceof AppError)
            throw error;
        throw new AppError("Failed to send verification email. Please try again shortly.", 502, { cause: error });
    }
}
//# sourceMappingURL=elasticemail.service.js.map